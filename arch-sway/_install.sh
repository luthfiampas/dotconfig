...
configure_vs_code() {
    ...
    retry_command "code --install-extension anweber.vscode-httpyac"
    retry_command "code --install-extension bradlc.vscode-tailwindcss"
    ...
    retry_command "code --install-extension foxundermoon.shell-format@7.2.5"
    retry_command "code --install-extension golang.go"
    ...
    retry_command "code --install-extension qwtel.sqlite-viewer"
    retry_command "code --install-extension redhat.vscode-yaml"
    retry_command "code --install-extension renesaarsoo.sql-formatter-vsc"
